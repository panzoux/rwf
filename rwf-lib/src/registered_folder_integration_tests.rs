...
mod tests {
    ...
    fn test_show_registered_folder_dialog() {
        ...
        state
            .registered_folders
            .add(RegisteredFolder::new("Home", "/home/user"));
        state
            .registered_folders
            .add(RegisteredFolder::new("Work", "/work/project"));
    ...
    fn test_navigate_to_registered_folder() {
        ...
        state
            .registered_folders
            .add(RegisteredFolder::new("Test", "/test/path"));

        // Navigate to the folder
        let result = update_state(
            &mut state,
            Transition::NavigateToRegisteredFolder { folder_index: 0 },
        );
    ...
    fn test_navigate_to_invalid_folder_index() {
        ...
        let result = update_state(
            &mut state,
            Transition::NavigateToRegisteredFolder { folder_index: 99 },
        );
    ...
    fn test_environment_variable_expansion_in_navigation() {
        ...
        state
            .registered_folders
            .add(RegisteredFolder::new("Home", "$TEST_HOME/documents"));
    ...
    fn test_environment_variable_expansion_unix_braces() {
        ...
        state.registered_folders.add(RegisteredFolder::new(
            "Test",
            "${TEST_VAR_INTEGRATION_UNIX_BRACES}/path",
        ));
    ...
    fn test_environment_variable_expansion_powershell() {
        ...
        state.registered_folders.add(RegisteredFolder::new(
            "Test",
            "$env:TEST_VAR_INTEGRATION_POWERSHELL/path",
        ));
    ...
    fn test_move_marked_files_to_registered_folder() {
        ...
        state
            ...
            .left_pane
            .marking
            .mark(Location::Local(PathBuf::from("/source/file1.txt")));
        state
            .current_tab_mut()
            .left_pane
            .marking
            .mark(Location::Local(PathBuf::from("/source/file2.txt")));

        // Add a registered folder
        state
            .registered_folders
            .add(RegisteredFolder::new("Destination", "/dest/folder"));

        // Move marked files to the registered folder
        let result = update_state(
            &mut state,
            Transition::MoveToRegisteredFolder { folder_index: 0 },
        );
    ...
    fn test_move_to_invalid_registered_folder() {
        ...
        state
            ...
            .left_pane
            .marking
            .mark(Location::Local(PathBuf::from("/source/file.txt")));

        // Try to move to a non-existent folder
        let result = update_state(
            &mut state,
            Transition::MoveToRegisteredFolder { folder_index: 99 },
        );
    ...
    fn test_multiple_environment_variables_in_path() {
        ...
        state
            .registered_folders
            .add(RegisteredFolder::new("Test", "$VAR1/${VAR2}/path"));
    ...
    fn test_nonexistent_environment_variable_unchanged() {
        ...
        state
            .registered_folders
            .add(RegisteredFolder::new("Test", "$NONEXISTENT_VAR/path"));
        ...
        match location {
            Location::Local(path) => {
                ...
                assert!(
                    path_str.contains("NONEXISTENT_VAR") || path_str == "$NONEXISTENT_VAR/path"
                );
            }
    ...
    fn test_registered_folder_selector_dialog_confirmation_for_navigation() {
        ...
        state
            .registered_folders
            .add(RegisteredFolder::new("Folder1", "/path1"));
        state
            .registered_folders
            .add(RegisteredFolder::new("Folder2", "/path2"));

        // Show the selector dialog
        let folders = state.registered_folders.folders.clone();
        state
            .dialogs
            .push(crate::model::Dialog::registered_folder_selector(folders));
    ...
    fn test_registered_folder_selector_dialog_confirmation_for_move() {
        ...
        state
            .registered_folders
            .add(RegisteredFolder::new("Destination", "/dest"));

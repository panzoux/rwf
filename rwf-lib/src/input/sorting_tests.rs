...
mod tests {
    ...
    fn test_directory_first_all_sort_modes() {
        ...
        for sort_mode in &[
            ...
            assert!(
                sorted[0].is_dir,
                "First entry should be directory for {:?}",
                sort_mode
            );
            assert!(
                sorted[1].is_dir,
                "Second entry should be directory for {:?}",
                sort_mode
            );
            ...
            assert!(
                !sorted[2].is_dir,
                "Third entry should be file for {:?}",
                sort_mode
            );
            assert!(
                !sorted[3].is_dir,
                "Fourth entry should be file for {:?}",
                sort_mode
            );
        }
    }
    ...
    fn test_sort_stability_equal_elements() {
        ...
        assert_eq!(
            ...
            "Sort should be stable for equal elements"
        );
    }
    ...
    fn test_sort_order_dirs_always_first() {
        ...
        assert!(
            result[0].is_dir,
            "Directory should be first even in descending order"
        );

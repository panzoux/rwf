...
mod tests {
    ...
    fn test_wildcard_pattern_execution() {
        ...
        assert!(state
            ...
            .left_pane
            .marking
            .is_marked(&Location::Local(PathBuf::from("/test/document.pdf"))));
        assert!(state
            .current_tab_mut()
            .left_pane
            .marking
            .is_marked(&Location::Local(PathBuf::from("/test/report.pdf"))));
        assert!(!state
            .current_tab_mut()
            .left_pane
            .marking
            .is_marked(&Location::Local(PathBuf::from("/test/image.png"))));
        assert!(!state
            .current_tab_mut()
            .left_pane
            .marking
            .is_marked(&Location::Local(PathBuf::from("/test/photo.jpg"))));
        assert!(!state
            .current_tab_mut()
            .left_pane
            .marking
            .is_marked(&Location::Local(PathBuf::from("/test/data.csv"))));
    }
    ...
    fn test_range_marking_execution() {
        ...
        assert!(state
            ...
            .left_pane
            .marking
            .is_marked(&entries[5].location));
        assert!(state
            .current_tab_mut()
            .left_pane
            .marking
            .is_marked(&entries[6].location));
        assert!(!state
            .current_tab_mut()
            .left_pane
            .marking
    ...
    fn test_invert_marks() {
        ...
        assert!(!state
            ...
            .left_pane
            .marking
            .is_marked(&entries[0].location)); // was marked, now unmarked
        assert!(state
            .current_tab_mut()
            .left_pane
            .marking
            .is_marked(&entries[1].location)); // was unmarked, now marked
        assert!(!state
            .current_tab_mut()
            .left_pane
            .marking
            .is_marked(&entries[2].location)); // was marked, now unmarked
        assert!(state
            .current_tab_mut()
            .left_pane
            .marking
            .is_marked(&entries[3].location)); // was unmarked, now marked
        assert!(state
            .current_tab_mut()
            .left_pane
            .marking
            .is_marked(&entries[4].location)); // was unmarked, now marked
    }

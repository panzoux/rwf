...
mod tests {
    ...
    async fn test_archive_browsing_root() {
        ...
        let entries = handler.list_entries(&archive_location, &cancel_token).await.unwrap();
    ...
    async fn test_archive_extraction_all() {
        ...
        let cancel_token = CancellationToken::new();
        handler.extract_all(&archive_location, &dest_location, &cancel_token).await.unwrap();
    ...
    async fn test_archive_creation() {
        ...
        let cancel_token = CancellationToken::new();
        handler.create_archive(&sources, &dest_location, &cancel_token).await.unwrap();
        ...
        handler.extract_all(&archive_location, &extract_location, &cancel_token).await.unwrap();

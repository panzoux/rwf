...
#[cfg(test)]
mod tests {
    use crate::config::{Action, ConfigManager, KeyBindings};
    ...
    fn test_twf_compatible_defaults() {
        ...
        assert_eq!(
            keybindings.normal_mode.get("Shift+K"),
    ...
    fn test_navigation_key_bindings() {
        ...
        assert_eq!(
            keybindings.normal_mode.get("Down"),
        ...
        assert_eq!(
            keybindings.normal_mode.get("PageDown"),
    ...
    fn test_directory_navigation_key_bindings() {
        ...
        assert_eq!(
            keybindings.normal_mode.get("Enter"),
            Some(&Action::EnterDirectory)
        );
        assert_eq!(
            keybindings.normal_mode.get("Backspace"),
            Some(&Action::ParentDirectory)
        );
        assert_eq!(
            keybindings.normal_mode.get("Left"),
            Some(&Action::ParentDirectory)
        );
    }
    ...
    fn test_marking_key_bindings() {
        ...
        assert_eq!(
            keybindings.normal_mode.get("Space"),
            Some(&Action::ToggleMark)
        );
        assert_eq!(keybindings.normal_mode.get("*"), Some(&Action::MarkAll));
        assert_eq!(
            keybindings.normal_mode.get("Ctrl+U"),
            Some(&Action::UnmarkAll)
        );
    }
    ...
    fn test_search_key_bindings() {
        ...
        assert_eq!(
            keybindings.normal_mode.get("Ctrl+F"),
    ...
    fn test_history_key_bindings() {
        ...
        assert_eq!(
            keybindings.normal_mode.get("Alt+Left"),
            Some(&Action::HistoryBack)
        );
        assert_eq!(
            keybindings.normal_mode.get("Alt+Right"),
    ...
    fn test_config_reload_key_binding() {
        ...
        assert_eq!(
            keybindings.normal_mode.get("Shift+Z"),
    ...
    fn test_save_and_load_keybindings() {
        ...
        assert_eq!(
            loaded_keybindings.normal_mode.get("Tab"),
            Some(&Action::SwitchPane)
        );
    }

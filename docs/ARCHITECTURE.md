...
**通知を「そのペインを今すぐポーリングせよ」というトリガーとして追加する案**を 7.5b で検討する
（[plan/7.5b.native_fs_watcher.md](../plan/7.5b.native_fs_watcher.md)）。
...
| Layer 2: ネイティブ FS 監視をポーリングのトリガーに | Phase 7.5b | `[ ]` |

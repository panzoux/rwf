//! Jump to Directory dialog rendering and input handling.
//!
...
use rwf_lib::model::dialog::JumpToPathDialog;

use super::DialogAction;

/// Handle key input: text input + AND-filter suggestions + arrow navigation.
pub(super) fn handle_input(
    dialog: &mut JumpToPathDialog,
    key: KeyEvent,
    search: Option<&rwf_lib::model::SearchModel>,
) -> DialogAction {
    let JumpToPathDialog {
        query,
        cursor_pos,
        suggestions,
        selected_index,

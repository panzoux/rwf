...
- [x] JobManager(S4 batch1, commit `037623b`, struct名は `JobManagerContent`) / [ ] PatternRename / [ ] ComparisonView / [x] SplitJoinDialog(S4 batch2, commit `1bf13a7`, struct名は `SplitJoinDialogContent`)
